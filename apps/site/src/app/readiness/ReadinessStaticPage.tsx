...
function profileKey(value: string | null): ProfileKey {
...
export function ReadinessInteractive() {
  ...
  return (
    <ReadinessContent
      diagnosticIntent={searchParams.get('next') === 'architecture-diagnostic'}
      selectedKey={profileKey(searchParams.get('profile'))}
    />
  )
}
