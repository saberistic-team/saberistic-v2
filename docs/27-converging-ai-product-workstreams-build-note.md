...
Blueprint activation commit `4d066d384e379ddea62f287e518e7da75b487074` passed CI
`33587795182` and CodeQL `33587794536`. Web deploy `dep-dabplf3bc2fs73ep8pm0` and Static Site
deploy `dep-dabplf3bc2fs73ep8qsg` became live on that commit. Startup migrations reported `Done`,
the final health response identified `4d066d384e37`, `/api/ready` returned `ready`, the public Gift
page returned `200`, and the activation release window contained no error-level or 5xx log entry.
